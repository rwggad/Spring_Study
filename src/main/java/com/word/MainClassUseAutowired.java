...
public class MainClassUseAutowired {
	...
	public static void main(String[] args) {
		 ...
		 * 간단한 단어를 검색하는 프로젝트
		 *
		 * 예시로 c, c++, java, jsp, spring과그  언어에대한 설명이 있다.
		 *
		 * 이것 또한 DataBase 대신 임시 데이터로 이용하는 것*/
		...
		WordRegisterServiceUseAutowired registerService =
				ctx.getBean("registerServiceUseAutowired", WordRegisterServiceUseAutowired.class);
		...
		WordSearchServiceUseAutowired searchService =
				ctx.getBean("searchServiceUseAutowired", WordSearchServiceUseAutowired.class);
