...
/**
 * example1~6 까지는 스프링 컨테이너를 xml파일로 작성했다.
 *
 *
 * 이번예제는 스프링 컨테이너를 java 파일로 설정하는 법에 대한 예제이다
 *
 * 밑의 소스 파일들은 example3에서 했던 학생정보 관리 시스템 소스파일들이다.
 * (MainClass, MainClassUseXML, MainClassUseXMLs)
 * */
